...
/**
 * Consent class. consents have a class, unique key, 
 */
class Consent {
     ...
     */
    constructor(consentClass, keyParts) {
        this.class = consentClass;
        this.key = Consent.makeKey(keyParts);
    ...
    getSplitKey(){
        return Consent.splitKey(this.key);
    }
